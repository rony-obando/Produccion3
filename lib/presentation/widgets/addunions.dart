...
class AddProductos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> items1 = watch.VU.where((element) => !element.EsProducto).map((element) => element.name).toList();
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Seleccionar padre',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,)),
          ...
          const SizedBox(height: 20),
          const Text('Seleccionar hijo',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,),),
          const SizedBox(height: 20),
          SizedBox(
            width: 200,
            child: DropdownButton<String>(
            ...
            value: watch.selectedUV1.isEmpty?items1.first:watch.selectedUV1,
            onChanged: (text) {
          ...
          ElevatedButton(
            onPressed: () {
              context.read<ProductProvider>().addUnions(watch.selectedUV, watch.selectedUV1, watch.cantidad);
            },
